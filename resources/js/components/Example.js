...
class MaterialCalcForm extends React.Component {
    ...
    constructor(props) {
      super(props);
      this.state = {width: '', iwidth: '', wwidth: '', length: '', sqfoot: '', calculate: '', resultClass: ''};
    ...
    // console.log('aa:' + aa); console.log('cc:' + cc);
      ...
      //console.log(rr);
      this.setState({ calculate: rr,sqfoot:""});
      ...
      return (
        <div>
          <form onSubmit={this.handleSubmit} action="javascript:void(0);" >
            ...
            <p>OR</p>
            <label htmlFor="width-of-wall">Width of Wallcovering</label>
            <input id="width-of-wall" type="text" placeholder="Width of Wallcovering"value={this.state.wwidth} onChange={this.handlewWidth} />
  ...
  if (document.getElementById('materialcalc-container')) {
    ReactDOM.render(<MaterialCalcForm />, document.getElementById('materialcalc-container'));
  }
